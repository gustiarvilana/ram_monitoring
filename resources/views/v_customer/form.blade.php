            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group row">
                        <label for="nosp" class="col-md-2 col-md-offset-1 control-label">Nosp</label>
                        <div class="col-md-6">
                            <input type="text" name="no_sp" id="nosp" class="form-control" required>
                            <span class="help-block with-errors"></span>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="nama_customer" class="col-md-2 col-md-offset-1 control-label">nama_customer</label>
                        <div class="col-md-6">
                    ...
                    <div class="form-group row">
                        <label for="alamat" class="col-md-2 col-md-offset-1 control-label">lamat</label>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <select name="level" id="level">
                                ...
                                @foreach ($jabatan as $item) 
                                    <option value="{{ $item->kode_jabatan }}">{{ $item->nama_customer_jabatan }}</option>
                                @endforeach
                            </select>
                            <span class="help-block with-errors"></span>
                        </div>
